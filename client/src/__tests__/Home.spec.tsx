...
import { updateColumnSuccessDND } from "../mocks/dnd";
...
describe("home page", () => {
    it("should render,get initial values correctly", async () => {
        ...
        // check initial tasks
        expect(
            await screen.findByText(/Take out the garbage/i)
        ).toBeInTheDocument();
        expect(
            await screen.findByText(/Watch my favorite show/i)
        ).toBeInTheDocument();
    });
    ...
    describe("column tests", () => {
        ...
        it("should return error,if create column form item is empty", async () => {
            ...
            expect(
                await screen.findByText(/Please provide the text../i)
            ).toBeInTheDocument();
        });
        ...
        it("should return error,if there is a column with same column name", async () => {
            ...
            // check error
            expect(
                await screen.findByText("You have the same name of a column...")
            ).toBeInTheDocument();
        });
        ...
        it("should return error message,if update form item is empty", async () => {
            ...
            userEvent.click(screen.getByRole("button", { name: /submit/i }));
            expect(
                await screen.findByText(/Please provide the name.../i)
            ).toBeInTheDocument();
        });
        ...
        it("should return error message, while updating the column with name of a existing column", async () => {
            ...
            expect(
                await screen.findByText(/There is a column with same name.../i)
            ).toBeInTheDocument();
        });
        ...
        it("should delete the column correctly", async () => {
            ...
            expect(
                await screen.findByText(/deleted the column/i)
            ).toBeInTheDocument();
        });
    });
    ...
    describe("task tests", () => {
        it("should create a new task correctly", async () => {
            ...
            userEvent.selectOptions(
                screen.getByPlaceholderText(/Choose Tag/),
                "High"
            );
            userEvent.selectOptions(
                await screen.findByPlaceholderText(/Choose Column/),
                "column-2"
            );
            userEvent.click(screen.getByRole("button", { name: /submit/i }));
        ...
        it("should return error message,if the create task input is empty", async () => {
            ...
            userEvent.click(screen.getByRole("button", { name: /submit/i }));
            expect(
                await screen.findByText(/Please provide all inputs.../i)
            ).toBeInTheDocument();
        });
        ...
        it("should return error message,if there is a task with same name", async () => {
            ...
            expect(
                await screen.findByText(/There is a task with same content./i)
            ).toBeInTheDocument();
        });
        ...
        it("should update the task correctly", async () => {
            ...
            userEvent.selectOptions(
                screen.getByPlaceholderText(/Choose Tag/i),
                "High"
            );
            userEvent.click(screen.getByRole("button", { name: /submit/i }));
        ...
        it("should return error message, if there is a task with same content,while updating", async () => {
            ...
            expect(
                await screen.findByText("There is a task with same content.")
            ).toBeInTheDocument();
        });
        ...
        it("should delete the task correctly", async () => {
            ...
            await waitForElementToBeRemoved(() =>
                screen.queryByText("Take out the garbage")
            );
    ...
    describe("dnd", () => {
        ...
        it("should move a task up inside a column", async () => {
            ...
            expect((await screen.findAllByTestId("task-item"))[0]).toHaveTextContent(
                "Take out the garbage"
            );
            ...
            expect((await screen.findAllByTestId("task-item"))[1]).toHaveTextContent(
                "Take out the garbage"
            );
        });
